...
const CC = 'Foto ilustrativa da espécie · Wikimedia Commons';
const f = (id: string) => `/aves-stima/${id}.webp`;

export const PLANTEL_STIMA: Variedade[] = [
  // ---------------- PAVÕES ----------------
  { id: 'pavao-azul', nome: 'Pavão Azul', cientifico: 'Pavo cristatus', categoria: 'pavoes', grupo: 'Pavões', preco: 800, foto: f('pavao-azul'), foto_credito: CC,
  ...
  { id: 'pavao-branco', nome: 'Pavão Branco', cientifico: 'Pavo cristatus (mut.)', categoria: 'pavoes', grupo: 'Pavões', preco: 1200, foto: f('pavao-branco'), foto_credito: CC,
  ...
  { id: 'pavao-arlequim', nome: 'Pavão Arlequim', cientifico: 'Pavo cristatus (mut.)', categoria: 'pavoes', grupo: 'Pavões', preco: 1200, foto: f('pavao-arlequim'), foto_credito: CC,
  ...
  // ---------------- FAISÕES ----------------
  { id: 'faisao-lady-amherst', nome: 'Faisão Lady Amherst', cientifico: 'Chrysolophus amherstiae', categoria: 'faisoes', grupo: 'Faisões', preco: 400, foto: f('faisao-lady-amherst'), foto_credito: CC,
  ...
  { id: 'faisao-dourado', nome: 'Faisão Dourado', cientifico: 'Chrysolophus pictus', categoria: 'faisoes', grupo: 'Faisões', preco: 800, foto: f('faisao-dourado'), foto_credito: CC,
  ...
  { id: 'faisao-prata', nome: 'Faisão Prata', cientifico: 'Lophura nycthemera', categoria: 'faisoes', grupo: 'Faisões', preco: 800, foto: f('faisao-prata'), foto_credito: CC,
  ...
  { id: 'faisao-venerado', nome: 'Faisão Venerado', cientifico: 'Syrmaticus reevesii', categoria: 'faisoes', grupo: 'Faisões', preco: null, foto: f('faisao-venerado'), foto_credito: CC,
  ...
  { id: 'faisao-swinhoe', nome: 'Faisão Swinhoe', cientifico: 'Lophura swinhoii', categoria: 'faisoes', grupo: 'Faisões', preco: 1500, foto: f('faisao-swinhoe'), foto_credito: CC,
  ...
  { id: 'faisao-prelado', nome: 'Faisão Prelado', cientifico: 'Lophura diardi', categoria: 'faisoes', grupo: 'Faisões', preco: 3800, foto: f('faisao-prelado'), foto_credito: CC,
  ...
  { id: 'galo-sonnerat', nome: 'Galo Sonnerat', cientifico: 'Gallus sonneratii', categoria: 'faisoes', grupo: 'Faisões', preco: null, foto: f('galo-sonnerat'), foto_credito: CC,
  ...
  // ---------------- PERDIZES E CODORNAS ----------------
  { id: 'perdiz-chukar', nome: 'Perdiz Chukar', cientifico: 'Alectoris chukar', categoria: 'perdizes', grupo: 'Perdizes e codornas', preco: null, foto: f('perdiz-chukar'), foto_credito: CC,
  ...
  { id: 'codorna-escamada', nome: 'Codorna Escamada', cientifico: 'Callipepla squamata', categoria: 'perdizes', grupo: 'Perdizes e codornas', preco: null, foto: f('codorna-escamada'), foto_credito: CC,
  ...
  { id: 'codorna-california', nome: 'Codorna Califórnia', cientifico: 'Callipepla californica', categoria: 'perdizes', grupo: 'Perdizes e codornas', preco: 1500, foto: f('codorna-california'), foto_credito: CC,
  ...
  // ---------------- PSITACÍDEOS ----------------
  { id: 'ring-neck', nome: 'Ring Neck', cientifico: 'Psittacula krameri (mut.)', categoria: 'psitacideos', grupo: 'Psitacídeos', preco: 3500, foto: f('ring-neck'), foto_credito: CC,
  ...
  { id: 'rosela', nome: 'Rosela', cientifico: 'Platycercus eximius', categoria: 'psitacideos', grupo: 'Psitacídeos', preco: null, foto: f('rosela'), foto_credito: CC,
  ...
  { id: 'loris-molucano', nome: 'Lóris Molucano', cientifico: 'Eos bornea', categoria: 'psitacideos', grupo: 'Psitacídeos', preco: 6000, foto: f('loris-molucano'), foto_credito: CC,
  ...
  // ---------------- POMBAS ----------------
  { id: 'pomba-guine', nome: 'Pomba Guiné', cientifico: 'Columba guinea', categoria: 'pombas', grupo: 'Pombas', preco: 250, foto: f('pomba-guine'), foto_credito: CC,
  ...
  { id: 'pomba-lofote', nome: 'Pomba Lofote', cientifico: 'Ocyphaps lophotes', categoria: 'pombas', grupo: 'Pombas', preco: 750, foto: f('pomba-lofote'), foto_credito: CC,
  ...
  { id: 'pomba-senegal', nome: 'Pomba Senegal', cientifico: 'Spilopelia senegalensis', categoria: 'pombas', grupo: 'Pombas', preco: 800, foto: f('pomba-senegal'), foto_credito: CC,
  ...
  { id: 'pomba-asa-verde', nome: 'Pomba Asa Verde', cientifico: 'Chalcophaps indica', categoria: 'pombas', grupo: 'Pombas', preco: 1500, foto: f('pomba-asa-verde'), foto_credito: CC,
  ...
  { id: 'rolinha-zebrinha', nome: 'Rolinha Zebrinha', cientifico: 'Geopelia striata', categoria: 'pombas', grupo: 'Pombas', preco: null, foto: f('rolinha-zebrinha'), foto_credito: CC,
  ...
  { id: 'pato-mandarim', nome: 'Pato Mandarim', cientifico: 'Aix galericulata', categoria: 'aquaticas', grupo: 'Patos, marrecos e cisne', preco: 1200, foto: f('pato-mandarim'), foto_credito: CC,
  ...
  { id: 'pato-carolina', nome: 'Pato Carolina', cientifico: 'Aix sponsa', categoria: 'aquaticas', grupo: 'Patos, marrecos e cisne', preco: 1500, foto: f('pato-carolina'), foto_credito: CC,
  ...
  { id: 'marreco-cool-mosaico', nome: 'Marreco Cool Mosaico', cientifico: 'Anas platyrhynchos', categoria: 'aquaticas', grupo: 'Patos, marrecos e cisne', preco: 400, foto: null,
  ...
  { id: 'marreco-cool-arlequim', nome: 'Marreco Cool Arlequim', cientifico: 'Anas platyrhynchos', categoria: 'aquaticas', grupo: 'Patos, marrecos e cisne', preco: 400, foto: null,
  ...
  { id: 'marreco-cool-gray', nome: 'Marreco Cool Gray', cientifico: 'Anas platyrhynchos', categoria: 'aquaticas', grupo: 'Patos, marrecos e cisne', preco: 350, foto: f('marreco-cool-gray'), foto_credito: CC,
  ...
  { id: 'marreco-cool-branco', nome: 'Marreco Cool Branco', cientifico: 'Anas platyrhynchos', categoria: 'aquaticas', grupo: 'Patos, marrecos e cisne', preco: 450, foto: null,
  ...
  { id: 'marreco-spotbill', nome: 'Marreco Spotbill', cientifico: 'Anas poecilorhyncha', categoria: 'aquaticas', grupo: 'Patos, marrecos e cisne', preco: 500, foto: null,
  ...
  { id: 'cisne-negro', nome: 'Cisne Negro', cientifico: 'Cygnus atratus', categoria: 'aquaticas', grupo: 'Patos, marrecos e cisne', preco: null, foto: f('cisne-negro'), foto_credito: CC,
  ...
  // ---------------- TADORNAS E GANSOS ----------------
  { id: 'tadorna-ferruginea', nome: 'Tadorna Ferrugínea', cientifico: 'Tadorna ferruginea', categoria: 'aquaticas', grupo: 'Tadornas e gansos', preco: null, foto: f('tadorna-ferruginea'), foto_credito: CC,
  ...
  { id: 'tadorna-radjah', nome: 'Tadorna Radjah', cientifico: 'Radjah radjah', categoria: 'aquaticas', grupo: 'Tadornas e gansos', preco: 4000, foto: f('tadorna-radjah'), foto_credito: CC,
  ...
  { id: 'tadorna-tricolor', nome: 'Tadorna Tricolor', cientifico: 'Tadorna tadorna', categoria: 'aquaticas', grupo: 'Tadornas e gansos', preco: 5500, foto: null,
  ...
  { id: 'ganso-do-egito', nome: 'Ganso do Egito', cientifico: 'Alopochen aegyptiaca', categoria: 'aquaticas', grupo: 'Tadornas e gansos', preco: 900, foto: null,
  ...
  { id: 'ganso-do-egito-branco', nome: 'Ganso do Egito Branco', cientifico: 'Alopochen aegyptiaca (mut.)', categoria: 'aquaticas', grupo: 'Tadornas e gansos', preco: 1500, foto: null,
  ...
  { id: 'ganso-canadense', nome: 'Ganso Canadense', cientifico: 'Branta canadensis', categoria: 'aquaticas', grupo: 'Tadornas e gansos', preco: null, foto: f('ganso-canadense'), foto_credito: CC,
  ...
  { id: 'ganso-do-havai', nome: 'Ganso do Havaí', cientifico: 'Branta sandvicensis', categoria: 'aquaticas', grupo: 'Tadornas e gansos', preco: 7000, foto: null,
  ...
  // ---------------- TURACOS ----------------
  { id: 'turaco-persa', nome: 'Turaco Persa', cientifico: 'Tauraco persa', categoria: 'turacos', grupo: 'Turacos', preco: 15000, foto: f('turaco-persa'), foto_credito: CC,
  ...
  { id: 'turaco-violeta', nome: 'Turaco Violeta', cientifico: 'Musophaga violacea', categoria: 'turacos', grupo: 'Turacos', preco: 9000, foto: f('turaco-violeta'), foto_credito: CC,
  ...
  { id: 'turaco-orelha-branca', nome: 'Turaco Orelha-branca', cientifico: 'Tauraco leucotis', categoria: 'turacos', grupo: 'Turacos', preco: 4000, foto: f('turaco-orelha-branca'), foto_credito: CC,
