...
export const PLANTEL_STIMA: Variedade[] = [
  ...
  { id: 'pato-mandarim', nome: 'Pato Mandarim', cientifico: 'Aix galericulata', categoria: 'aquaticas', grupo: 'Patos, marrecos e cisne', preco: 1200, foto: f('pato-mandarim'), foto_credito: 'Foto: Alexis Lours · CC BY 4.0 · Wikimedia Commons',
  ...
  { id: 'pato-carolina', nome: 'Pato Carolina', cientifico: 'Aix sponsa', categoria: 'aquaticas', grupo: 'Patos, marrecos e cisne', preco: 1500, foto: null,
  ...
  { id: 'marreco-cool-gray', nome: 'Marreco Cool Gray', cientifico: 'Anas platyrhynchos', categoria: 'aquaticas', grupo: 'Patos, marrecos e cisne', preco: 350, foto: f('marreco-cool-gray'), foto_credito: 'Foto: shankar s. · CC BY 2.0 · Wikimedia Commons',
  ...
  // ---------------- TADORNAS E GANSOS ----------------
  { id: 'tadorna-ferruginea', nome: 'Tadorna Ferrugínea', cientifico: 'Tadorna ferruginea', categoria: 'aquaticas', grupo: 'Tadornas e gansos', preco: null, foto: f('tadorna-ferruginea'), foto_credito: 'Foto: Michael Gäbler · CC BY 3.0 · Wikimedia Commons',
  ...
  { id: 'tadorna-radjah', nome: 'Tadorna Radjah', cientifico: 'Radjah radjah', categoria: 'aquaticas', grupo: 'Tadornas e gansos', preco: 4000, foto: f('tadorna-radjah'), foto_credito: 'Foto: Gzen92 · CC BY-SA 4.0 · Wikimedia Commons',
