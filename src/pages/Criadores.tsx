        ...
        <div className="wrap mt-10">
          <div className="card p-8 grid grid-cols-1 md:grid-cols-[1.4fr_0.6fr] gap-5 items-center">
            <div>
              ...
              <h2 className="text-[1.5rem] text-[var(--verde)] m-0 mb-2">Você não negocia com três criadouros.</h2>
              <p lang="pt-BR" className="font-serif text-[1rem] text-[var(--muted)] m-0 text-justify hyphens-auto">Escolhe as aves de quem quiser e monta um pedido só. Se estiver começando, diga o que procura e para que espaço — a gente indica o criadouro certo. A AOB acerta com cada um, junta tudo na mesma rota e você paga na entrega, ave por ave, ao conferir. Um WhatsApp só: {CONSTANTS.WHATSAPP_DISPLAY}.</p>
            </div>
