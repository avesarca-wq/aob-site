          ...
          {CRIADORES.map((c) => {
            ...
            return (
              <div key={c.id} className="card p-7">
                <div className="h-36 mb-5 flex items-center justify-center rounded-xl bg-white border border-[#E1DCCF] px-5 py-3">
                  {c.logo
                    ? <img src={c.logo} alt={`Logotipo ${c.nome}`} className="max-h-full max-w-full w-auto h-auto object-contain" loading="lazy" />
