...
export const Privacidade: React.FC = () => (
  <>
    ...
    <section className="section" style={{ paddingTop: 32 }}>
      <div className="wrap max-w-3xl font-serif text-[1.02rem] text-[var(--ink)]">
        ...
        <p className="font-sans text-[0.78rem] text-[var(--muted)]">Última atualização: setembro de 2026.</p>
      </div>
    </section>
  </>
);
